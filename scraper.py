...
# রাত ৮টা থেকে ১২:৫৯ পর্যন্ত স্পোর্টস চলবে
CARTOON_LINK = "https://ranapkbd.site/RANAPK33p/TVD/play.php?id=372986"  # রাত ১টা - সন্ধ্যা ৭:৫৯
SPORTS_LINK = "https://ranapkbd.site/RANAPK33p/TVD/play.php?id=809382"    # রাত ৮টা - রাত ১২:৫৯
...
def get_channel_3_link():
    ...
    # রাত ৮টা (২০) থেকে রাত ১২:৫৯ (০) পর্যন্ত SPORTS লিংক
    if current_hour >= 20 or current_hour < 1:
        return SPORTS_LINK
    else:
        # বাকি সময় CARTOON লিংক
        return CARTOON_LINK
...
def generate_playlist():
    ...
    with open("playlist.m3u", "w", encoding="utf-8") as f:
        f.write(m3u_content)
    print("Playlist updated successfully! (SPORTS mode active from 8PM)")
